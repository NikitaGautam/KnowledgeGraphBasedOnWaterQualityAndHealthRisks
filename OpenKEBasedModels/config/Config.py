...
class Config(object):
    ...
    def init(self):
        ...
        self.valid_h1 = np.zeros(self.relTotal, dtype=np.int64)
        self.valid_t1 = np.zeros(self.relTotal, dtype=np.int64)
        self.valid_r1 = np.zeros(self.relTotal, dtype=np.int64)
        self.valid_h_addr1 = self.valid_h1.__array_interface__["data"][0]
        self.valid_t_addr1 = self.valid_t1.__array_interface__["data"][0]
        self.valid_r_addr1 = self.valid_r1.__array_interface__["data"][0]
        
        self.test_h1 = np.zeros(self.relTotal, dtype=np.int64)
        self.test_t1 = np.zeros(self.relTotal, dtype=np.int64)
        self.test_r1 = np.zeros(self.relTotal, dtype=np.int64)
        self.test_h_addr1 = self.test_h1.__array_interface__["data"][0]
        self.test_t_addr1 = self.test_t1.__array_interface__["data"][0]
        self.test_r_addr1 = self.test_r1.__array_interface__["data"][0]
    ...
    def set_test_rel(self, test_rel):
    ...
    def valid(self, model):
        ...
        for i in range(self.validTotal):
            ...
            self.lib.getValidRelBatch(
                self.valid_h_addr1, self.valid_t_addr1, self.valid_r_addr1
            )
            res = self.test_one_step(model, self.valid_h1, self.valid_t1, self.valid_r1)
    ...
    def relation_prediction(self):
        ...
        for i in range(self.testTotal):
            ...
            self.lib.getRelBatch(self.test_h_addr1, self.test_t_addr1, self.test_r_addr1)
          
            res = self.test_one_step(
                self.testModel, self.test_h1, self.test_t1, self.test_r1
            )
