# After downloading the predicates files from the SemMedDB the following scripts can be used to create datasets for fine-tuning the BERT and RoBERTa models.
